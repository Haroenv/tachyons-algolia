...
module.exports = {
  ...
  init(externalVars) {
    return {
      ...
      ...this.colors,
      colors: this.colors,
      'spacing-extra-extra-extra-extra-large': '32rem',
      candor: this.colors.shamrock,
      care: this.colors.koromiko,
      grit: this.colors['royal-blue'],
      humility: this.colors.mulberry,
      trust: this.colors['algolia-blue'],
      code: {
        blue: '#5F87AF',
        'dark-green': '#008700',
        gold: externalVars.gold,
        gray: externalVars['mid-gray'],
        green: '#00AF5F',
        orange: externalVars.orange,
        purple: '#7F81FE',
        red: this.colors.bittersweet,
        white: externalVars['light-gray'],
        yellow: externalVars.yellow,
      },
      gradients: {
        green: {
          angle: '320deg',
          start: this.colors.shamrock,
          end: this.colors.java,
        },
        blue: {
          angle: '256deg',
          start: this.colors['algolia-blue'],
          end: this.colors['royal-blue'],
        },
        pink: {
          angle: '256deg',
          start: this.colors.bittersweet,
          end: this.colors['radical-red'],
        },
        orange: {
          angle: '256deg',
          start: this.colors.koromiko,
          end: this.colors.bittersweet,
        },
        'light-blue': {
          angle: '269deg',
          start: this.colors['algolia-blue'],
        ...
        dark: {
          angle: '256deg',
          start: this.colors['deep-cove'],
          end: this.colors.bunting,
        },
      },
      fontAwesome: {
        '500px': '\\f26e',
